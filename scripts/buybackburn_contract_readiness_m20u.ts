...
export function createBuybackBurnImplementationReadinessM20U(
  ...
  return {
    ...
    requiredBeforeProductionImplementation: [
      ...
      'fixed-floor frozen quote and dex_min_out policy',
    ...
    candidateContractSurface: {
      messages: [
        ...
        'ExecuteBuybackChunk only after post-seal FreezeBuybackRoute records final fixed-floor route values',
    ...
    implementationAcceptanceMatrix: [
      ...
      { label: 'frozen quote/minOut is a fixed floor and not a caller-supplied dynamic quote', required: true, source: 'SECTION4/FEEBUY-03' },
      { label: 'ordinary ATH sent to the official BuybackBurn ATH wallet is untracked and not burn-due', required: true, source: 'SECTION4/FEEBUY-04' },
    ...
    forbidden: [
      ...
      'treating the frozen BuybackBurn minOut as a dynamic fair-market quote',
      'using the official BuybackBurn ATH wallet as a deposit or surplus-burn address',
