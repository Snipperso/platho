...
- The one-shot `ATHMaster.DeployTreasurySupply` transaction is a CEREMONY STEP (D02) and has NOT been performed for clean-17. It mints the entire supply into the treasury owner's ATH wallet; until it runs, no ATH exists at all. Once it runs, that wallet must hold `100,000,000 ATH`. [CORRECTED 2026-07-31 - this said the transaction "is complete", true of the clean-15 deployment and false of the release this document gates. A reader checking readiness would have concluded the mint was done and skipped it.]
- AirdropPool activity airdrop backing is a CEREMONY STEP and has NOT been performed for clean-17: the official AirdropPool ATH wallet must be funded with `15,000,000 ATH`, and the live verifier must prove that backing before user publish rewards are live. [CORRECTED 2026-07-31 - this named `Vault` as custodian and called the funding complete. Vault was DELETED in clean-17; AirdropPool replaces it.]
