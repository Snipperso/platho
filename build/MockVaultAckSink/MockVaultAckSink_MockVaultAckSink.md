...
### ForwardVaultPublic
TL-B: `forward_vault_public#fa001002 capsule_hub_address:address bounce_id:uint64 bounce_tag:uint160 publish_id:uint256 marketing_note:uint152 author_wallet:address header_hash:uint256 body_hash:uint256 header:^cell body:^cell protocol_fee_paid:uint128 value_to_capsule:uint128 = ForwardVaultPublic`
Signature: `ForwardVaultPublic{capsule_hub_address:address,bounce_id:uint64,bounce_tag:uint160,publish_id:uint256,marketing_note:uint152,author_wallet:address,header_hash:uint256,body_hash:uint256,header:^cell,body:^cell,protocol_fee_paid:uint128,value_to_capsule:uint128}`
