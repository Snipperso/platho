...
### ForwardVaultPrivate
TL-B: `forward_vault_private#fa001001 capsule_hub_address:address bounce_id:uint64 bounce_tag:uint160 publish_id:uint256 size_class:uint8 crypto_suite:uint8 header_0_hash:uint256 header_1_hash:uint256 body_hash:uint256 header_0:^cell header_1:^cell body:^cell protocol_fee_paid:uint128 value_to_capsule:uint128 = ForwardVaultPrivate`
Signature: `ForwardVaultPrivate{capsule_hub_address:address,bounce_id:uint64,bounce_tag:uint160,publish_id:uint256,size_class:uint8,crypto_suite:uint8,header_0_hash:uint256,header_1_hash:uint256,body_hash:uint256,header_0:^cell,header_1:^cell,body:^cell,protocol_fee_paid:uint128,value_to_capsule:uint128}`

### ForwardVaultPublic
TL-B: `forward_vault_public#fa001002 capsule_hub_address:address bounce_id:uint64 bounce_tag:uint160 publish_id:uint256 size_class:uint8 marketing_note:uint152 author_wallet:address header_hash:uint256 body_hash:uint256 header:^cell body:^cell protocol_fee_paid:uint128 value_to_capsule:uint128 = ForwardVaultPublic`
Signature: `ForwardVaultPublic{capsule_hub_address:address,bounce_id:uint64,bounce_tag:uint160,publish_id:uint256,size_class:uint8,marketing_note:uint152,author_wallet:address,header_hash:uint256,body_hash:uint256,header:^cell,body:^cell,protocol_fee_paid:uint128,value_to_capsule:uint128}`
