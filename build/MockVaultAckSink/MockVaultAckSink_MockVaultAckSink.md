...
### ForwardVaultPublic
TL-B: `forward_vault_public#fa001002 capsule_hub_address:address bounce_id:uint64 publish_id:uint256 author_wallet:address body_hash:uint256 protocol_fee_paid:uint128 value_to_capsule:uint128 = ForwardVaultPublic`
Signature: `ForwardVaultPublic{capsule_hub_address:address,bounce_id:uint64,publish_id:uint256,author_wallet:address,body_hash:uint256,protocol_fee_paid:uint128,value_to_capsule:uint128}`
