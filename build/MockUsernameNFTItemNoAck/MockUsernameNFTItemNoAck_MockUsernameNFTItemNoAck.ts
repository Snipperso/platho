...
export type MockUsernameNFTItemNoAck$Data = {
    $$type: 'MockUsernameNFTItemNoAck$Data';
    accepted_count: bigint;
}

export function storeMockUsernameNFTItemNoAck$Data(src: MockUsernameNFTItemNoAck$Data) {
    return (builder: Builder) => {
        const b_0 = builder;
...
export function loadMockUsernameNFTItemNoAck$Data(slice: Slice) {
    const sc_0 = slice;
    const _accepted_count = sc_0.loadUintBig(64);
    return { $$type: 'MockUsernameNFTItemNoAck$Data' as const, accepted_count: _accepted_count };
}

export function loadTupleMockUsernameNFTItemNoAck$Data(source: TupleReader) {
    const _accepted_count = source.readBigNumber();
    return { $$type: 'MockUsernameNFTItemNoAck$Data' as const, accepted_count: _accepted_count };
}

export function loadGetterTupleMockUsernameNFTItemNoAck$Data(source: TupleReader) {
    const _accepted_count = source.readBigNumber();
    return { $$type: 'MockUsernameNFTItemNoAck$Data' as const, accepted_count: _accepted_count };
}

export function storeTupleMockUsernameNFTItemNoAck$Data(source: MockUsernameNFTItemNoAck$Data) {
    const builder = new TupleBuilder();
    builder.writeNumber(source.accepted_count);
    return builder.build();
}

export function dictValueParserMockUsernameNFTItemNoAck$Data(): DictionaryValue<MockUsernameNFTItemNoAck$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeMockUsernameNFTItemNoAck$Data(src)).endCell());
        },
        parse: (src) => {
            return loadMockUsernameNFTItemNoAck$Data(src.loadRef().beginParse());
        }
    }
}

 type MockUsernameNFTItemNoAck_init_args = {
    $$type: 'MockUsernameNFTItemNoAck_init_args';
}

function initMockUsernameNFTItemNoAck_init_args(src: MockUsernameNFTItemNoAck_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
export const MockUsernameNFTItemNoAck_errors = {
...
export const MockUsernameNFTItemNoAck_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const MockUsernameNFTItemNoAck_types: ABIType[] = [
...
const MockUsernameNFTItemNoAck_getters: ABIGetter[] = [
    {"name":"get_accepted_count","methodId":109210,"arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
]

export const MockUsernameNFTItemNoAck_getterMapping: { [key: string]: string } = {
    'get_accepted_count': 'getGetAcceptedCount',
}
...
export class MockUsernameNFTItemNoAck implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = MockUsernameNFTItemNoAck_errors_backward;
    public static readonly opcodes = MockUsernameNFTItemNoAck_opcodes;
    
    static async init() {
        return await MockUsernameNFTItemNoAck_init();
    }
    
    static async fromInit() {
        const __gen_init = await MockUsernameNFTItemNoAck_init();
        const address = contractAddress(0, __gen_init);
        return new MockUsernameNFTItemNoAck(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new MockUsernameNFTItemNoAck(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  MockUsernameNFTItemNoAck_types,
        getters: MockUsernameNFTItemNoAck_getters,
        receivers: MockUsernameNFTItemNoAck_receivers,
        errors: MockUsernameNFTItemNoAck_errors,
    };
    ...
    async getGetAcceptedCount(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get('get_accepted_count', builder.build())).stack;
