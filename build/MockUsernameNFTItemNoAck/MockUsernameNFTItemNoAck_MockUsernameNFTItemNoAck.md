...
### MockUsernameNFTItemNoAck$Data
TL-B: `_ accepted_count:uint64 = MockUsernameNFTItemNoAck`
Signature: `MockUsernameNFTItemNoAck{accepted_count:uint64}`
...
```mermaid
graph TD
MockUsernameNFTItemNoAck
MockUsernameNFTItemNoAck --> BaseTrait
```
