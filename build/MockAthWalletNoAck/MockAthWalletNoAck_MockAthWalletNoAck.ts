...
export function storeMockAthWalletNoAck$Data(src: MockAthWalletNoAck$Data) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}

export function loadMockAthWalletNoAck$Data(slice: Slice) {
    const sc_0 = slice;
    return { $$type: 'MockAthWalletNoAck$Data' as const };
}

export function loadTupleMockAthWalletNoAck$Data(source: TupleReader) {
    return { $$type: 'MockAthWalletNoAck$Data' as const };
}

export function loadGetterTupleMockAthWalletNoAck$Data(source: TupleReader) {
    return { $$type: 'MockAthWalletNoAck$Data' as const };
}

export function storeTupleMockAthWalletNoAck$Data(source: MockAthWalletNoAck$Data) {
    const builder = new TupleBuilder();
    return builder.build();
}

export function dictValueParserMockAthWalletNoAck$Data(): DictionaryValue<MockAthWalletNoAck$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeMockAthWalletNoAck$Data(src)).endCell());
        },
        parse: (src) => {
            return loadMockAthWalletNoAck$Data(src.loadRef().beginParse());
        }
    }
}

 type MockAthWalletNoAck_init_args = {
    $$type: 'MockAthWalletNoAck_init_args';
}

function initMockAthWalletNoAck_init_args(src: MockAthWalletNoAck_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
export const MockAthWalletNoAck_errors = {
...
export const MockAthWalletNoAck_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const MockAthWalletNoAck_types: ABIType[] = [
...
export const MockAthWalletNoAck_getterMapping: { [key: string]: string } = {
}
...
export class MockAthWalletNoAck implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = MockAthWalletNoAck_errors_backward;
    public static readonly opcodes = MockAthWalletNoAck_opcodes;
    
    static async init() {
        return await MockAthWalletNoAck_init();
    }
    
    static async fromInit() {
        const __gen_init = await MockAthWalletNoAck_init();
        const address = contractAddress(0, __gen_init);
        return new MockAthWalletNoAck(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new MockAthWalletNoAck(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  MockAthWalletNoAck_types,
        getters: MockAthWalletNoAck_getters,
        receivers: MockAthWalletNoAck_receivers,
        errors: MockAthWalletNoAck_errors,
    };
