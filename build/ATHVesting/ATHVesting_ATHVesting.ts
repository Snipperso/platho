...
export type ClaimAthVesting = {
    $$type: 'ClaimAthVesting';
    query_id: bigint;
    amount: bigint;
}

export function storeClaimAthVesting(src: ClaimAthVesting) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeUint(1096046147, 32);
        b_0.storeUint(src.query_id, 64);
        b_0.storeUint(src.amount, 128);
    };
}

export function loadClaimAthVesting(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 1096046147) { throw Error('Invalid prefix'); }
    const _query_id = sc_0.loadUintBig(64);
    const _amount = sc_0.loadUintBig(128);
    return { $$type: 'ClaimAthVesting' as const, query_id: _query_id, amount: _amount };
}

export function loadTupleClaimAthVesting(source: TupleReader) {
    const _query_id = source.readBigNumber();
    const _amount = source.readBigNumber();
    return { $$type: 'ClaimAthVesting' as const, query_id: _query_id, amount: _amount };
}

export function loadGetterTupleClaimAthVesting(source: TupleReader) {
    const _query_id = source.readBigNumber();
    const _amount = source.readBigNumber();
    return { $$type: 'ClaimAthVesting' as const, query_id: _query_id, amount: _amount };
}

export function storeTupleClaimAthVesting(source: ClaimAthVesting) {
    const builder = new TupleBuilder();
    builder.writeNumber(source.query_id);
    builder.writeNumber(source.amount);
    return builder.build();
...
export function dictValueParserClaimAthVesting(): DictionaryValue<ClaimAthVesting> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeClaimAthVesting(src)).endCell());
        },
        parse: (src) => {
            return loadClaimAthVesting(src.loadRef().beginParse());
        }
    }
}

export type ATHVestingTopUpStorageReserve = {
    $$type: 'ATHVestingTopUpStorageReserve';
}

export function storeATHVestingTopUpStorageReserve(src: ATHVestingTopUpStorageReserve) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeUint(1096046164, 32);
    };
}

export function loadATHVestingTopUpStorageReserve(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 1096046164) { throw Error('Invalid prefix'); }
    return { $$type: 'ATHVestingTopUpStorageReserve' as const };
}

export function loadTupleATHVestingTopUpStorageReserve(source: TupleReader) {
    return { $$type: 'ATHVestingTopUpStorageReserve' as const };
}

export function loadGetterTupleATHVestingTopUpStorageReserve(source: TupleReader) {
    return { $$type: 'ATHVestingTopUpStorageReserve' as const };
}

export function storeTupleATHVestingTopUpStorageReserve(source: ATHVestingTopUpStorageReserve) {
    const builder = new TupleBuilder();
    return builder.build();
}

export function dictValueParserATHVestingTopUpStorageReserve(): DictionaryValue<ATHVestingTopUpStorageReserve> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeATHVestingTopUpStorageReserve(src)).endCell());
        },
        parse: (src) => {
            return loadATHVestingTopUpStorageReserve(src.loadRef().beginParse());
        }
    }
}

export type ATHVestingConfigView = {
    $$type: 'ATHVestingConfigView';
    ath_master_address: Address;
    ...
    period_count: bigint;
    period_unlock_amount: bigint;
    total_amount: bigint;
}

export function storeATHVestingConfigView(src: ATHVestingConfigView) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.ath_master_address);
        b_0.storeAddress(src.beneficiary_address);
        b_0.storeAddress(src.official_ath_wallet_address);
        const b_1 = new Builder();
        b_1.storeInt(src.start_time, 257);
        b_1.storeInt(src.period_seconds, 257);
        b_1.storeInt(src.period_count, 257);
        const b_2 = new Builder();
        b_2.storeInt(src.period_unlock_amount, 257);
        b_2.storeInt(src.total_amount, 257);
        b_1.storeRef(b_2.endCell());
        b_0.storeRef(b_1.endCell());
    };
}

export function loadATHVestingConfigView(slice: Slice) {
    const sc_0 = slice;
    const _ath_master_address = sc_0.loadAddress();
    const _beneficiary_address = sc_0.loadAddress();
    const _official_ath_wallet_address = sc_0.loadAddress();
    const sc_1 = sc_0.loadRef().beginParse();
    const _start_time = sc_1.loadIntBig(257);
    const _period_seconds = sc_1.loadIntBig(257);
    const _period_count = sc_1.loadIntBig(257);
    const sc_2 = sc_1.loadRef().beginParse();
    const _period_unlock_amount = sc_2.loadIntBig(257);
    const _total_amount = sc_2.loadIntBig(257);
    return { $$type: 'ATHVestingConfigView' as const, ath_master_address: _ath_master_address, beneficiary_address: _beneficiary_address, official_ath_wallet_address: _official_ath_wallet_address, start_time: _start_time, period_seconds: _period_seconds, period_count: _period_count, period_unlock_amount: _period_unlock_amount, total_amount: _total_amount };
}

export function loadTupleATHVestingConfigView(source: TupleReader) {
    const _ath_master_address = source.readAddress();
    const _beneficiary_address = source.readAddress();
    const _official_ath_wallet_address = source.readAddress();
    const _start_time = source.readBigNumber();
    const _period_seconds = source.readBigNumber();
    const _period_count = source.readBigNumber();
    const _period_unlock_amount = source.readBigNumber();
    const _total_amount = source.readBigNumber();
    return { $$type: 'ATHVestingConfigView' as const, ath_master_address: _ath_master_address, beneficiary_address: _beneficiary_address, official_ath_wallet_address: _official_ath_wallet_address, start_time: _start_time, period_seconds: _period_seconds, period_count: _period_count, period_unlock_amount: _period_unlock_amount, total_amount: _total_amount };
}

export function loadGetterTupleATHVestingConfigView(source: TupleReader) {
    const _ath_master_address = source.readAddress();
    const _beneficiary_address = source.readAddress();
    const _official_ath_wallet_address = source.readAddress();
    const _start_time = source.readBigNumber();
...
export function storeTupleATHVestingConfigView(source: ATHVestingConfigView) {
    const builder = new TupleBuilder();
    builder.writeAddress(source.ath_master_address);
    builder.writeAddress(source.beneficiary_address);
    builder.writeAddress(source.official_ath_wallet_address);
    builder.writeNumber(source.start_time);
    builder.writeNumber(source.period_seconds);
    builder.writeNumber(source.period_count);
    builder.writeNumber(source.period_unlock_amount);
    builder.writeNumber(source.total_amount);
    return builder.build();
}

export function dictValueParserATHVestingConfigView(): DictionaryValue<ATHVestingConfigView> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeATHVestingConfigView(src)).endCell());
        },
        parse: (src) => {
            return loadATHVestingConfigView(src.loadRef().beginParse());
        }
    }
}

export type ATHVestingStateView = {
    $$type: 'ATHVestingStateView';
    phase: bigint;
    claimed_ath: bigint;
    vested_ath: bigint;
    claimable_ath: bigint;
...
export function storeATHVestingStateView(src: ATHVestingStateView) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeInt(src.phase, 257);
        b_0.storeInt(src.claimed_ath, 257);
        b_0.storeInt(src.vested_ath, 257);
        const b_1 = new Builder();
        b_1.storeInt(src.claimable_ath, 257);
        b_1.storeInt(src.pending_query_id, 257);
        b_1.storeInt(src.pending_amount, 257);
        const b_2 = new Builder();
        b_2.storeAddress(src.pending_recipient_ath_wallet);
        b_2.storeInt(src.pending_created_at, 257);
        b_2.storeInt(src.last_terminal_query_id, 257);
        b_1.storeRef(b_2.endCell());
        b_0.storeRef(b_1.endCell());
    };
}

export function loadATHVestingStateView(slice: Slice) {
    const sc_0 = slice;
    const _phase = sc_0.loadIntBig(257);
    const _claimed_ath = sc_0.loadIntBig(257);
    const _vested_ath = sc_0.loadIntBig(257);
    const sc_1 = sc_0.loadRef().beginParse();
    const _claimable_ath = sc_1.loadIntBig(257);
    const _pending_query_id = sc_1.loadIntBig(257);
    const _pending_amount = sc_1.loadIntBig(257);
    const sc_2 = sc_1.loadRef().beginParse();
    const _pending_recipient_ath_wallet = sc_2.loadAddress();
    const _pending_created_at = sc_2.loadIntBig(257);
    const _last_terminal_query_id = sc_2.loadIntBig(257);
    return { $$type: 'ATHVestingStateView' as const, phase: _phase, claimed_ath: _claimed_ath, vested_ath: _vested_ath, claimable_ath: _claimable_ath, pending_query_id: _pending_query_id, pending_amount: _pending_amount, pending_recipient_ath_wallet: _pending_recipient_ath_wallet, pending_created_at: _pending_created_at, last_terminal_query_id: _last_terminal_query_id };
}

export function loadTupleATHVestingStateView(source: TupleReader) {
    const _phase = source.readBigNumber();
    const _claimed_ath = source.readBigNumber();
    const _vested_ath = source.readBigNumber();
    const _claimable_ath = source.readBigNumber();
    const _pending_query_id = source.readBigNumber();
    const _pending_amount = source.readBigNumber();
    const _pending_recipient_ath_wallet = source.readAddress();
    const _pending_created_at = source.readBigNumber();
    const _last_terminal_query_id = source.readBigNumber();
    return { $$type: 'ATHVestingStateView' as const, phase: _phase, claimed_ath: _claimed_ath, vested_ath: _vested_ath, claimable_ath: _claimable_ath, pending_query_id: _pending_query_id, pending_amount: _pending_amount, pending_recipient_ath_wallet: _pending_recipient_ath_wallet, pending_created_at: _pending_created_at, last_terminal_query_id: _last_terminal_query_id };
}

export function loadGetterTupleATHVestingStateView(source: TupleReader) {
    const _phase = source.readBigNumber();
    const _claimed_ath = source.readBigNumber();
    const _vested_ath = source.readBigNumber();
    const _claimable_ath = source.readBigNumber();
...
export function storeTupleATHVestingStateView(source: ATHVestingStateView) {
    const builder = new TupleBuilder();
    builder.writeNumber(source.phase);
    builder.writeNumber(source.claimed_ath);
    builder.writeNumber(source.vested_ath);
    builder.writeNumber(source.claimable_ath);
    builder.writeNumber(source.pending_query_id);
    builder.writeNumber(source.pending_amount);
    builder.writeAddress(source.pending_recipient_ath_wallet);
    builder.writeNumber(source.pending_created_at);
    builder.writeNumber(source.last_terminal_query_id);
    return builder.build();
}

export function dictValueParserATHVestingStateView(): DictionaryValue<ATHVestingStateView> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeATHVestingStateView(src)).endCell());
        },
        parse: (src) => {
            return loadATHVestingStateView(src.loadRef().beginParse());
        }
    }
}

export type ATHVesting$Data = {
    $$type: 'ATHVesting$Data';
    ath_master_address: Address;
    beneficiary_address: Address;
    start_time: bigint;
    claimed_ath: bigint;
...
export function storeATHVesting$Data(src: ATHVesting$Data) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.ath_master_address);
        b_0.storeAddress(src.beneficiary_address);
        b_0.storeUint(src.start_time, 64);
        b_0.storeUint(src.claimed_ath, 128);
        b_0.storeUint(src.phase, 8);
        b_0.storeUint(src.pending_query_id, 64);
        b_0.storeUint(src.pending_amount, 128);
        const b_1 = new Builder();
        b_1.storeAddress(src.pending_recipient_ath_wallet);
        b_1.storeUint(src.pending_created_at, 64);
        b_1.storeUint(src.last_terminal_query_id, 64);
        b_0.storeRef(b_1.endCell());
    };
}

export function loadATHVesting$Data(slice: Slice) {
    const sc_0 = slice;
    const _ath_master_address = sc_0.loadAddress();
    const _beneficiary_address = sc_0.loadAddress();
    const _start_time = sc_0.loadUintBig(64);
    const _claimed_ath = sc_0.loadUintBig(128);
    const _phase = sc_0.loadUintBig(8);
    const _pending_query_id = sc_0.loadUintBig(64);
    const _pending_amount = sc_0.loadUintBig(128);
    const sc_1 = sc_0.loadRef().beginParse();
    const _pending_recipient_ath_wallet = sc_1.loadAddress();
    const _pending_created_at = sc_1.loadUintBig(64);
    const _last_terminal_query_id = sc_1.loadUintBig(64);
    return { $$type: 'ATHVesting$Data' as const, ath_master_address: _ath_master_address, beneficiary_address: _beneficiary_address, start_time: _start_time, claimed_ath: _claimed_ath, phase: _phase, pending_query_id: _pending_query_id, pending_amount: _pending_amount, pending_recipient_ath_wallet: _pending_recipient_ath_wallet, pending_created_at: _pending_created_at, last_terminal_query_id: _last_terminal_query_id };
}

export function loadTupleATHVesting$Data(source: TupleReader) {
    const _ath_master_address = source.readAddress();
    const _beneficiary_address = source.readAddress();
    const _start_time = source.readBigNumber();
    const _claimed_ath = source.readBigNumber();
...
export function loadGetterTupleATHVesting$Data(source: TupleReader) {
    const _ath_master_address = source.readAddress();
    const _beneficiary_address = source.readAddress();
    const _start_time = source.readBigNumber();
    const _claimed_ath = source.readBigNumber();
...
export function storeTupleATHVesting$Data(source: ATHVesting$Data) {
    const builder = new TupleBuilder();
    builder.writeAddress(source.ath_master_address);
    builder.writeAddress(source.beneficiary_address);
    builder.writeNumber(source.start_time);
...
export function dictValueParserATHVesting$Data(): DictionaryValue<ATHVesting$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeATHVesting$Data(src)).endCell());
        },
        parse: (src) => {
            return loadATHVesting$Data(src.loadRef().beginParse());
        }
    }
}

 type ATHVesting_init_args = {
    $$type: 'ATHVesting_init_args';
    ath_master_address: Address;
    beneficiary_address: Address;
    start_time: bigint;
...
function initATHVesting_init_args(src: ATHVesting_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.ath_master_address);
        b_0.storeAddress(src.beneficiary_address);
...
async function ATHVesting_init(ath_master_address: Address, beneficiary_address: Address, start_time: bigint) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initATHVesting_init_args({ $$type: 'ATHVesting_init_args', ath_master_address, beneficiary_address, start_time })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

export const ATHVesting_errors = {
...
export const ATHVesting_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const ATHVesting_types: ABIType[] = [
    ...
    {"name":"ClaimAthVesting","header":1096046147,"fields":[{"name":"query_id","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":128}}]},
    {"name":"ATHVestingTopUpStorageReserve","header":1096046164,"fields":[]},
    {"name":"ATHVestingConfigView","header":null,"fields":[{"name":"ath_master_address","type":{"kind":"simple","type":"address","optional":false}},{"name":"beneficiary_address","type":{"kind":"simple","type":"address","optional":false}},{"name":"official_ath_wallet_address","type":{"kind":"simple","type":"address","optional":false}},{"name":"start_time","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"period_seconds","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"period_count","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"period_unlock_amount","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"total_amount","type":{"kind":"simple","type":"int","optional":false,"format":257}}]},
    {"name":"ATHVestingStateView","header":null,"fields":[{"name":"phase","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"claimed_ath","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"vested_ath","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"claimable_ath","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"pending_query_id","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"pending_amount","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"pending_recipient_ath_wallet","type":{"kind":"simple","type":"address","optional":false}},{"name":"pending_created_at","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"last_terminal_query_id","type":{"kind":"simple","type":"int","optional":false,"format":257}}]},
    {"name":"ATHVesting$Data","header":null,"fields":[{"name":"ath_master_address","type":{"kind":"simple","type":"address","optional":false}},{"name":"beneficiary_address","type":{"kind":"simple","type":"address","optional":false}},{"name":"start_time","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"claimed_ath","type":{"kind":"simple","type":"uint","optional":false,"format":128}},{"name":"phase","type":{"kind":"simple","type":"uint","optional":false,"format":8}},{"name":"pending_query_id","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"pending_amount","type":{"kind":"simple","type":"uint","optional":false,"format":128}},{"name":"pending_recipient_ath_wallet","type":{"kind":"simple","type":"address","optional":false}},{"name":"pending_created_at","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"last_terminal_query_id","type":{"kind":"simple","type":"uint","optional":false,"format":64}}]},
]

const ATHVesting_opcodes = {
    "ATHBurn": 1096042497,
    ...
    "ClaimAthVesting": 1096046147,
    "ATHVestingTopUpStorageReserve": 1096046164,
}

const ATHVesting_getters: ABIGetter[] = [
    {"name":"get_vesting_config","methodId":115160,"arguments":[],"returnType":{"kind":"simple","type":"ATHVestingConfigView","optional":false}},
    {"name":"get_vesting_state","methodId":80660,"arguments":[],"returnType":{"kind":"simple","type":"ATHVestingStateView","optional":false}},
    {"name":"get_vested_amount","methodId":116022,"arguments":[{"name":"at_time","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
    {"name":"get_claimable_amount","methodId":127367,"arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
    {"name":"get_ath_wallet_address","methodId":108577,"arguments":[{"name":"owner","type":{"kind":"simple","type":"address","optional":false}}],"returnType":{"kind":"simple","type":"address","optional":false}},
]

export const ATHVesting_getterMapping: { [key: string]: string } = {
    'get_vesting_config': 'getGetVestingConfig',
    'get_vesting_state': 'getGetVestingState',
    'get_vested_amount': 'getGetVestedAmount',
    'get_claimable_amount': 'getGetClaimableAmount',
    'get_ath_wallet_address': 'getGetAthWalletAddress',
}

const ATHVesting_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"ClaimAthVesting"}},
    {"receiver":"internal","message":{"kind":"typed","type":"ATHTransferAck"}},
    {"receiver":"internal","message":{"kind":"typed","type":"ATHTransferFailed"}},
    {"receiver":"internal","message":{"kind":"typed","type":"ATHVestingTopUpStorageReserve"}},
...
export const ATH_VESTING_TOTAL_AMOUNT = 10000000000000000n;
export const ATH_VESTING_PERIOD_UNLOCK_AMOUNT = 100000000000000n;
export const ATH_VESTING_PERIOD_COUNT = 100n;
export const ATH_VESTING_PERIOD_SECONDS = 31536000n;
export const ATH_VESTING_TRANSFER_REQUEST_VALUE = 40000000n;
export const ATH_VESTING_LOCAL_EXEC_RESERVE = 2000000n;
export const ATH_VESTING_EXCESS_REFUND_MIN_VALUE = 100000n;
export const ATH_VESTING_PHASE_IDLE = 0n;
export const ATH_VESTING_PHASE_PENDING_TRANSFER = 1n;
export const UINT64_MAX = 18446744073709551615n;

export class ATHVesting implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = ATHVesting_errors_backward;
    public static readonly opcodes = ATHVesting_opcodes;
    
    static async init(ath_master_address: Address, beneficiary_address: Address, start_time: bigint) {
        return await ATHVesting_init(ath_master_address, beneficiary_address, start_time);
    }
    
    static async fromInit(ath_master_address: Address, beneficiary_address: Address, start_time: bigint) {
        const __gen_init = await ATHVesting_init(ath_master_address, beneficiary_address, start_time);
        const address = contractAddress(0, __gen_init);
        return new ATHVesting(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new ATHVesting(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  ATHVesting_types,
        getters: ATHVesting_getters,
        receivers: ATHVesting_receivers,
        errors: ATHVesting_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: ClaimAthVesting | ATHTransferAck | ATHTransferFailed | ATHVestingTopUpStorageReserve | null) {
        
        let body: Cell | null = null;
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'ClaimAthVesting') {
            body = beginCell().store(storeClaimAthVesting(message)).endCell();
        }
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'ATHVestingTopUpStorageReserve') {
            body = beginCell().store(storeATHVestingTopUpStorageReserve(message)).endCell();
        }
        if (message === null) {
            body = new Cell();
        }
    ...
    async getGetVestingConfig(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get('get_vesting_config', builder.build())).stack;
        const result = loadGetterTupleATHVestingConfigView(source);
        return result;
    }
    
    async getGetVestingState(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get('get_vesting_state', builder.build())).stack;
        const result = loadGetterTupleATHVestingStateView(source);
        return result;
    }
    
    async getGetVestedAmount(provider: ContractProvider, at_time: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(at_time);
        const source = (await provider.get('get_vested_amount', builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    
    async getGetClaimableAmount(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get('get_claimable_amount', builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    
    async getGetAthWalletAddress(provider: ContractProvider, owner: Address) {
        const builder = new TupleBuilder();
