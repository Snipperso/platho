...
### BindBuybackTreasury
TL-B: `bind_buyback_treasury#42594354 deployment_manifest_hash:uint256 treasury_address:address = BindBuybackTreasury`
Signature: `BindBuybackTreasury{deployment_manifest_hash:uint256,treasury_address:address}`

### FreezeBuybackRoute
TL-B: `freeze_buyback_route#42595246 deployment_manifest_hash:uint256 stonfi_router_address:address stonfi_pool_address_ton_ath:address stonfi_ath_source_owner_address:address stonfi_pton_wallet_address:address ask_jetton_wallet_address:address stonfi_referral_address:address referral_value_bps:uint16 buyback_min_ath_out_per_50_ton_atomic:uint128 evidence_quote_out_atomic_ath:uint128 evidence_dex_min_out_atomic_ath:uint128 route_evidence_hash:uint256 = FreezeBuybackRoute`
Signature: `FreezeBuybackRoute{deployment_manifest_hash:uint256,stonfi_router_address:address,stonfi_pool_address_ton_ath:address,stonfi_ath_source_owner_address:address,stonfi_pton_wallet_address:address,ask_jetton_wallet_address:address,stonfi_referral_address:address,referral_value_bps:uint16,buyback_min_ath_out_per_50_ton_atomic:uint128,evidence_quote_out_atomic_ath:uint128,evidence_dex_min_out_atomic_ath:uint128,route_evidence_hash:uint256}`
...
### RecoverStuckAthBurn
TL-B: `recover_stuck_ath_burn#42595342 query_id:uint64 = RecoverStuckAthBurn`
Signature: `RecoverStuckAthBurn{query_id:uint64}`

### SweepStuckReserveToTreasury
TL-B: `sweep_stuck_reserve_to_treasury#42595357  = SweepStuckReserveToTreasury`
Signature: `SweepStuckReserveToTreasury{}`
...
TL-B: `_ sealed:bool fee_bound:bool official_ath_wallet_bound:bool treasury_bound:bool route_frozen:bool treasury_address:address deployment_manifest_hash:int257 genesis_config_hash:int257 ath_master_address:address fee_accumulator_address:address official_ath_wallet_address:address stonfi_router_address:address stonfi_pool_address_ton_ath:address stonfi_ath_source_owner_address:address stonfi_pton_wallet_address:address ask_jetton_wallet_address:address stonfi_referral_address:address referral_value_bps:int257 buyback_min_ath_out_per_50_ton_atomic:int257 evidence_quote_out_atomic_ath:int257 evidence_dex_min_out_atomic_ath:int257 route_evidence_hash:int257 = BuybackBurnConfigView`
...
TL-B: `_ phase:int257 reserve_due_ton:int257 pending_query_id:int257 pending_deadline:int257 pending_route_refund_start_ton:int257 pending_dex_min_out_atomic_ath:int257 pending_received_ath_atomic:int257 pending_burn_at:int257 route_refund_due_ton:int257 ath_burn_retry_due_atomic:int257 last_terminal_query_id:int257 last_burn_at:int257 deadman_armed_at:int257 = BuybackBurnStateView`
Signature: `BuybackBurnStateView{phase:int257,reserve_due_ton:int257,pending_query_id:int257,pending_deadline:int257,pending_route_refund_start_ton:int257,pending_dex_min_out_atomic_ath:int257,pending_received_ath_atomic:int257,pending_burn_at:int257,route_refund_due_ton:int257,ath_burn_retry_due_atomic:int257,last_terminal_query_id:int257,last_burn_at:int257,deadman_armed_at:int257}`
...
### BuybackBurn$Data
TL-B: `_ genesis_config_hash:uint256 deployment_manifest_hash:uint256 ath_master_address:address fee_accumulator_address:address official_ath_wallet_address:address stonfi_router_address:address stonfi_pool_address_ton_ath:address stonfi_ath_source_owner_address:address stonfi_pton_wallet_address:address ask_jetton_wallet_address:address stonfi_referral_address:address fee_bound:bool official_ath_wallet_bound:bool route_frozen:bool sealed:bool treasury_address:address treasury_bound:bool last_burn_at:uint64 deadman_armed_at:uint64 referral_value_bps:uint16 buyback_min_ath_out_per_50_ton_atomic:uint128 evidence_quote_out_atomic_ath:uint128 evidence_dex_min_out_atomic_ath:uint128 route_evidence_hash:uint256 phase:uint8 reserve_due_ton:uint128 pending_query_id:uint64 pending_deadline:uint64 pending_route_refund_start_ton:uint128 pending_dex_min_out_atomic_ath:uint128 pending_received_ath_atomic:uint128 pending_burn_at:uint64 route_refund_due_ton:uint128 ath_burn_retry_due_atomic:uint128 last_terminal_query_id:uint64 accepted_reserve_count:uint64 executed_buyback_count:uint64 burned_ath_total_atomic:uint128 = BuybackBurn`
