...
TL-B: `_ phase:int257 reserve_due_ton:int257 pending_query_id:int257 pending_deadline:int257 pending_route_refund_start_ton:int257 pending_dex_min_out_atomic_ath:int257 pending_received_ath_atomic:int257 route_refund_due_ton:int257 ath_burn_retry_due_atomic:int257 = BuybackBurnStateView`
Signature: `BuybackBurnStateView{phase:int257,reserve_due_ton:int257,pending_query_id:int257,pending_deadline:int257,pending_route_refund_start_ton:int257,pending_dex_min_out_atomic_ath:int257,pending_received_ath_atomic:int257,route_refund_due_ton:int257,ath_burn_retry_due_atomic:int257}`
