...
### MockGasBurnNotifyOwner$Data
TL-B: `_ burn_iters:uint32 = MockGasBurnNotifyOwner`
Signature: `MockGasBurnNotifyOwner{burn_iters:uint32}`
...
```mermaid
graph TD
MockGasBurnNotifyOwner
MockGasBurnNotifyOwner --> BaseTrait
```
