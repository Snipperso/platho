...
const CACHE_NAME = 'platho-pwa-4674723ddfdc';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=372',
  ...
  './public-channel-subscriptions.mjs?v=69',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b04068aa9 while the cache holds ./app.js?v=b04068aa9. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b04068aa9<hash>, ./conv-lane.mjs?v=32). A changed file
