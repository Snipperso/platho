...
const CACHE_NAME = 'platho-pwa-165db82af5e0';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=339',
  ...
  './notes-lane.mjs?v=18',
  './public-lane-send.mjs?v=18',
  './public-lane.mjs?v=31',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b15329b2d while the cache holds ./app.js?v=b15329b2d. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b15329b2d<hash>, ./conv-lane.mjs?v=21). A changed file
