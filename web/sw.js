...
const CACHE_NAME = 'platho-pwa-268e43a7aa4f';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=372',
  ...
  './public-channel-subscriptions.mjs?v=70',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b62c18324 while the cache holds ./app.js?v=b62c18324. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b62c18324<hash>, ./conv-lane.mjs?v=32). A changed file
