const CACHE_NAME = 'platho-pwa-prototype-v513';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=141',
  ...
  './vault-ton-rpc-provider.mjs?v=43',
  './ton-dns-provider.mjs?v=23',
  './capsulehub-ton-rpc-provider.mjs?v=39',
  './ath-ton-rpc-provider.mjs?v=25',
  './profile-registry-ton-rpc-provider.mjs?v=27',
  './username-ton-rpc-provider.mjs?v=30',
