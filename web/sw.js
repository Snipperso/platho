...
const ASSETS = [
  ...
  './platho-wallet.mjs?v=23',
  './ton-mnemonic-wordlist.mjs?v=1',
  './pwa-contract-transactions.mjs?v=35',
  './publish-batch-orchestration.mjs?v=8',
  './ton-rpc-transport.mjs?v=69',
  './ton-dns-provider.mjs?v=47',
  './ath-ton-rpc-provider.mjs?v=48',
  './profile-registry-ton-rpc-provider.mjs?v=51',
  './username-ton-rpc-provider.mjs?v=53',
