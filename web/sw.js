...
const CACHE_NAME = 'platho-pwa-100a9121fe32';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=340',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b64d65d95 while the cache holds ./app.js?v=b64d65d95. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b64d65d95<hash>, ./conv-lane.mjs?v=28). A changed file
