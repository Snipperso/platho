const CACHE_NAME = 'platho-pwa-prototype-v902';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=277',
  './app.js?v=826',
  './i18n.mjs?v=34',
  './i18n-strings.mjs?v=36',
  './boot-signal-field.mjs?v=1',
  './boot-signal-worker.js?v=1',
  './vendor/telegram-web-app.js?v=1',
  './boot-guard.js?v=6',
  './platho-config.mjs?v=110',
  './capsule-part-policy.mjs?v=9',
  './message-pricing-policy.mjs?v=14',
  './public-channel-subscriptions.mjs?v=19',
  './recipient-identities.mjs?v=6',
  './channels/platho.app/feed.json',
  './encrypted-message-store.mjs?v=5',
  './platho-wallet.mjs?v=21',
  './ton-mnemonic-wordlist.mjs?v=1',
  './pwa-contract-transactions.mjs?v=35',
  './publish-batch-orchestration.mjs?v=8',
  './ton-rpc-transport.mjs?v=66',
  './ton-dns-provider.mjs?v=44',
  './ath-ton-rpc-provider.mjs?v=45',
  './profile-registry-ton-rpc-provider.mjs?v=48',
  './username-ton-rpc-provider.mjs?v=50',
  './crypto/platho-crypto.mjs?v=13',
