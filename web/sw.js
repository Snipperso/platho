...
const CACHE_NAME = 'platho-pwa-42a1bd1dc632';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=338',
  ...
  './public-channel-subscriptions.mjs?v=47',
  './recipient-identities.mjs?v=6',
  './channels/platho.app/feed.json',
  './encrypted-message-store.mjs?v=6',
  './platho-wallet.mjs?v=31',
  './ton-mnemonic-wordlist.mjs?v=1',
  './pwa-contract-transactions.mjs?v=37',
  './publish-batch-orchestration.mjs?v=10',
  './ton-rpc-transport.mjs?v=75',
  './ton-dns-provider.mjs?v=53',
  './ath-ton-rpc-provider.mjs?v=54',
  './profile-registry-ton-rpc-provider.mjs?v=57',
  './username-ton-rpc-provider.mjs?v=59',
  ...
  './airdrop-ticket-read.mjs?v=14',
  './conv-discovery.mjs?v=14',
  './conv-key-persist.mjs?v=4',
  './conv-key-store.mjs?v=2',
  './conv-lane-read.mjs?v=16',
  './conv-lane-send.mjs?v=14',
  './conv-lane.mjs?v=17',
  './conv-publish-browser.mjs?v=4',
  './conv-reply-bundle.mjs?v=4',
  './crypto/conv-routing.mjs?v=2',
  './crypto/intro-handshake.mjs',
  './intro-bucket.mjs?v=14',
  './intro-codec.mjs?v=2',
  './intro-cursor-store.mjs?v=1',
  './intro-lane-send.mjs?v=14',
  './intro-lane.mjs?v=20',
  './intro-publish-browser.mjs?v=14',
  './intro-receive-handler.mjs?v=4',
  './intro-receive.mjs',
  './intro-scan-policy.mjs?v=1',
  './intro-scan-runner.mjs?v=14',
  './intro-scan.mjs',
  './intro-send-coords.mjs?v=14',
  './intro-transport.mjs?v=15',
  './key-shard-register-browser.mjs?v=4',
  './key-shard-register-send.mjs?v=14',
  './key-shard-ton-rpc-provider.mjs?v=4',
  './market-stability-buy-send.mjs?v=1',
  './market-stability-read.mjs?v=1',
  './notes-lane.mjs?v=14',
  './public-lane-send.mjs?v=14',
  './public-lane.mjs?v=25',
  './public-publish-browser.mjs?v=4',
  './public-shard-ton-rpc-provider.mjs?v=4',
  './publish-price.mjs?v=1',
  './recovery-blob.mjs?v=4',
  './recovery-lane.mjs?v=14',
  './recovery-publish-browser.mjs?v=14',
  './recovery-transport.mjs?v=15',
  './shard-address.mjs?v=7',
  './shard-discovery.mjs?v=16',
  './shard-reader.mjs?v=14',
  './shard-rpc.mjs?v=15',
  './ton-stack-num.mjs?v=1',
  './wallet-send-fee.mjs?v=2',
