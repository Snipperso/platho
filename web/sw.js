...
const CACHE_NAME = 'platho-pwa-23b55bb5d98f';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=451',
  './app.js?v=bc4089efb',
  './i18n.mjs?v=132',
  './i18n-strings.mjs?v=134',
  './boot-signal-field.mjs?v=14',
  './cutover-epoch.mjs?v=4',
  './boot-signal-worker.js?v=15',
  './vendor/telegram-web-app.js?v=1',
  './vendor/lottie-web/lottie_light_canvas.min.js?v=1',
  './boot-guard.js?v=12',
  './platho-config.mjs?v=143',
  './capsule-part-policy.mjs?v=16',
  './message-pricing-policy.mjs?v=15',
  './public-channel-subscriptions.mjs?v=113',
  './thread-list-order.mjs?v=3',
  './keyed-rows.mjs?v=2',
  './recipient-identities.mjs?v=8',
  './channels/platho.app/feed.json',
  './encrypted-message-store.mjs?v=6',
  './platho-wallet.mjs?v=57',
  './ton-mnemonic-wordlist.mjs?v=1',
  './pwa-contract-transactions.mjs?v=47',
  './ton-rpc-transport.mjs?v=89',
  './ton-dns-provider.mjs?v=71',
  './ath-ton-rpc-provider.mjs?v=68',
  './profile-registry-ton-rpc-provider.mjs?v=71',
  './username-ton-rpc-provider.mjs?v=73',
  './crypto/platho-crypto.mjs?v=21',
  './replay-store.mjs?v=1',
  './profile-avatar-media-store.mjs?v=1',
  './webp-encoder.mjs?v=1',
  './qr-code.mjs?v=1',
  './conv-discovery.mjs?v=58',
  './conv-key-persist.mjs?v=21',
  './conv-key-store.mjs?v=12',
  './conv-lane-read.mjs?v=70',
  './conv-lane-send.mjs?v=62',
  './crypto/group-lane.mjs?v=5',
  './group-protocol.mjs?v=9',
  './public-reactions.mjs?v=4',
  './group-lane-send.mjs?v=13',
  './group-lane-read.mjs?v=11',
  './group-store.mjs?v=10',
  './group-record-store.mjs?v=2',
  './group-runtime.mjs?v=15',
  './fee-vault-read.mjs?v=7',
  './fee-vault.mjs?v=8',
  './conv-lane.mjs?v=79',
  './conv-publish-browser.mjs?v=30',
  './conv-reply-bundle.mjs?v=15',
  './m21c-envelope.mjs?v=3',
  './device-secret-store.mjs?v=2',
  './crypto/conv-routing.mjs?v=5',
  './crypto/intro-handshake.mjs?v=3',
  './intro-bucket.mjs?v=57',
  './intro-codec.mjs?v=2',
  './intro-cursor-store.mjs?v=6',
  './intro-lane-send.mjs?v=64',
  './intro-lane.mjs?v=79',
  './intro-publish-browser.mjs?v=57',
  './intro-receive-handler.mjs?v=17',
  './intro-receive.mjs?v=36',
  './intro-scan-policy.mjs?v=2',
  './intro-scan-runner.mjs?v=63',
  './intro-scan.mjs?v=6',
  './intro-send-coords.mjs?v=57',
  './intro-send-state.mjs?v=2',
  './intro-transport.mjs?v=63',
  './key-shard-register-browser.mjs?v=28',
  './key-shard-register-send.mjs?v=50',
  './key-shard-ton-rpc-provider.mjs?v=27',
  './market-stability-buy-send.mjs?v=27',
  './market-stability-read.mjs?v=1',
  './message-plain-text.mjs?v=1',
  './notes-lane.mjs?v=64',
  './public-lane-send.mjs?v=69',
  './public-lane.mjs?v=97',
  './public-publish-browser.mjs?v=37',
  './public-shard-ton-rpc-provider.mjs?v=28',
  './publish-price.mjs?v=9',
  './shard-debt.mjs?v=12',
  './moderation.mjs?v=9',
  './recovery-blob.mjs?v=16',
  './recovery-lane.mjs?v=65',
  './recovery-publish-browser.mjs?v=57',
  './recovery-transport.mjs?v=62',
  './shard-address.mjs?v=29',
  './vault-account.mjs?v=14',
  './shard-code.mjs?v=5',
  './shard-discovery.mjs?v=58',
  './shard-reader.mjs?v=61',
  './shard-rpc.mjs?v=40',
  './telegram-gift-nfts.mjs?v=5',
  './ton-stack-num.mjs?v=1',
  './username-nft-owned.mjs?v=13',
  './username-nft-transfer.mjs?v=11',
  './wallet-send-fee.mjs?v=29',
  ...
  // MEASURED MISSING [audit 2026-09-01, round 9]: both are referenced from styles.css and fetched on every cold
  // boot, and neither was here — so on the first offline (or server-down) launch after each release the wallet tab
  // icon and every close-button glyph were blank, including the control an offline reader needs to dismiss a
  // dialog. No coverage gate could see it: dropping any of these lines was measured green everywhere.
...
self.addEventListener('install', (event) => {
  ...
  // 🔴 CUTOVER: contracts18/docs/CUTOVER.md item 6. skipWaiting + clients.claim below make a new build take
  // effect on its next network-reachable load — an INSTALL-TIME switch. That is right for a hotfix and wrong for
  // the generation cutover, whose plan is an EPOCH boundary agreed by both client versions: an install-time flip
  // mid-epoch splits one conversation-direction-day across two accounts, each starting last_seq at 0. Whatever
  // carries the boundary must not be this.
  self.skipWaiting();
});
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=bc4089efb while the cache holds ./app.js?v=bc4089efb. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=bc4089efb<hash>, ./conv-lane.mjs?v=79). A changed file
