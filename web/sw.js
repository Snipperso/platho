const CACHE_NAME = 'platho-pwa-prototype-v734';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=215',
  ...
  './pwa-contract-transactions.mjs?v=32',
