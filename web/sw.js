...
const CACHE_NAME = 'platho-pwa-8bb13719b056';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=372',
  ...
  './public-channel-subscriptions.mjs?v=68',
  './thread-list-order.mjs?v=2',
  './keyed-rows.mjs?v=1',
  './recipient-identities.mjs?v=7',
  './channels/platho.app/feed.json',
  './encrypted-message-store.mjs?v=6',
  './platho-wallet.mjs?v=38',
  './ton-mnemonic-wordlist.mjs?v=1',
  './pwa-contract-transactions.mjs?v=37',
  './publish-batch-orchestration.mjs?v=10',
  './ton-rpc-transport.mjs?v=80',
  './ton-dns-provider.mjs?v=58',
  './ath-ton-rpc-provider.mjs?v=59',
  './profile-registry-ton-rpc-provider.mjs?v=62',
  './username-ton-rpc-provider.mjs?v=64',
  ...
  './airdrop-ticket-read.mjs?v=21',
  './conv-discovery.mjs?v=22',
  './conv-key-persist.mjs?v=7',
  './conv-key-store.mjs?v=5',
  './conv-lane-read.mjs?v=28',
  './conv-lane-send.mjs?v=21',
  './conv-lane.mjs?v=32',
  './conv-publish-browser.mjs?v=4',
  './conv-reply-bundle.mjs?v=5',
  './crypto/conv-routing.mjs?v=3',
  './crypto/intro-handshake.mjs',
  './intro-bucket.mjs?v=21',
  './intro-codec.mjs?v=2',
  './intro-cursor-store.mjs?v=1',
  './intro-lane-send.mjs?v=21',
  './intro-lane.mjs?v=37',
  './intro-publish-browser.mjs?v=21',
  './intro-receive-handler.mjs?v=7',
  './intro-receive.mjs',
  './intro-scan-policy.mjs?v=1',
  './intro-scan-runner.mjs?v=23',
  './intro-scan.mjs',
  './intro-send-coords.mjs?v=21',
  './intro-transport.mjs?v=28',
  './key-shard-register-browser.mjs?v=4',
  './key-shard-register-send.mjs?v=21',
  './key-shard-ton-rpc-provider.mjs?v=4',
  './market-stability-buy-send.mjs?v=8',
  './market-stability-read.mjs?v=1',
  './notes-lane.mjs?v=28',
  './public-lane-send.mjs?v=23',
  './public-lane.mjs?v=45',
  './public-publish-browser.mjs?v=6',
  './public-shard-ton-rpc-provider.mjs?v=6',
  './publish-price.mjs?v=1',
  './recovery-blob.mjs?v=6',
  './recovery-lane.mjs?v=28',
  './recovery-publish-browser.mjs?v=22',
  './recovery-transport.mjs?v=27',
  './shard-address.mjs?v=7',
  './shard-discovery.mjs?v=23',
  './shard-reader.mjs?v=26',
  './shard-rpc.mjs?v=24',
  './ton-stack-num.mjs?v=1',
  './wallet-send-fee.mjs?v=9',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b1283a01c while the cache holds ./app.js?v=b1283a01c. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b1283a01c<hash>, ./conv-lane.mjs?v=32). A changed file
