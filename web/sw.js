const CACHE_NAME = 'platho-pwa-prototype-v537';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=151',
  ...
  './vault-ton-rpc-provider.mjs?v=46',
  './ton-dns-provider.mjs?v=26',
  './capsulehub-ton-rpc-provider.mjs?v=42',
  './ath-ton-rpc-provider.mjs?v=28',
  './profile-registry-ton-rpc-provider.mjs?v=30',
  './username-ton-rpc-provider.mjs?v=33',
