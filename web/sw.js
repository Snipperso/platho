...
const CACHE_NAME = 'platho-pwa-ca576a8aa24f';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=371',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=bd42ddcf1 while the cache holds ./app.js?v=bd42ddcf1. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=bd42ddcf1<hash>, ./conv-lane.mjs?v=32). A changed file
