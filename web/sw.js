...
const CACHE_NAME = 'platho-pwa-cd2ece2c2261';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=340',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b0d8c8f66 while the cache holds ./app.js?v=b0d8c8f66. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b0d8c8f66<hash>, ./conv-lane.mjs?v=30). A changed file
