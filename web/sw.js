const CACHE_NAME = 'platho-pwa-prototype-v478';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=140',
  './app.js?v=415',
  './platho-config.mjs?v=71',
  ...
  './vault-ton-rpc-provider.mjs?v=35',
  './ton-dns-provider.mjs?v=20',
  './capsulehub-ton-rpc-provider.mjs?v=35',
  './ath-ton-rpc-provider.mjs?v=22',
  './profile-registry-ton-rpc-provider.mjs?v=24',
  './username-ton-rpc-provider.mjs?v=27',
