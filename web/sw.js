...
const CACHE_NAME = 'platho-pwa-db8cc7ead86f';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=340',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b28f7c8f3 while the cache holds ./app.js?v=b28f7c8f3. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b28f7c8f3<hash>, ./conv-lane.mjs?v=30). A changed file
