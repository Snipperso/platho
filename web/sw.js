...
const CACHE_NAME = 'platho-pwa-bf02b438af57';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=340',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b57564715 while the cache holds ./app.js?v=b57564715. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b57564715<hash>, ./conv-lane.mjs?v=27). A changed file
