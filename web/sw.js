...
const CACHE_NAME = 'platho-pwa-a4776e117a31';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=364',
  ...
  './public-channel-subscriptions.mjs?v=59',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=bfd3f729b while the cache holds ./app.js?v=bfd3f729b. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=bfd3f729b<hash>, ./conv-lane.mjs?v=32). A changed file
