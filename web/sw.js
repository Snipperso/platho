...
const CACHE_NAME = 'platho-pwa-83b6ac17e6bb';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=339',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b9925bed1 while the cache holds ./app.js?v=b9925bed1. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b9925bed1<hash>, ./conv-lane.mjs?v=21). A changed file
