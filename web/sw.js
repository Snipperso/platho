...
const ASSETS = [
  ...
  './platho-wallet.mjs?v=24',
  './ton-mnemonic-wordlist.mjs?v=1',
  './pwa-contract-transactions.mjs?v=35',
  './publish-batch-orchestration.mjs?v=8',
  './ton-rpc-transport.mjs?v=70',
  './ton-dns-provider.mjs?v=48',
  './ath-ton-rpc-provider.mjs?v=49',
  './profile-registry-ton-rpc-provider.mjs?v=52',
  './username-ton-rpc-provider.mjs?v=54',
