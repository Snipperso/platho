const CACHE_NAME = 'platho-pwa-prototype-v904';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=279',
  ...
  './ton-rpc-transport.mjs?v=67',
  './ton-dns-provider.mjs?v=45',
  './ath-ton-rpc-provider.mjs?v=46',
  './profile-registry-ton-rpc-provider.mjs?v=49',
  './username-ton-rpc-provider.mjs?v=51',
