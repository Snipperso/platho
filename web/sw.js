const CACHE_NAME = 'platho-pwa-prototype-v306';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=123',
  './app.js?v=246',
  './platho-config.mjs?v=45',
  './capsule-part-policy.mjs?v=3',
  './message-pricing-policy.mjs?v=10',
  './public-channel-subscriptions.mjs?v=6',
  './recipient-identities.mjs?v=3',
  './channels/platho.app/feed.json',
  './encrypted-message-store.mjs?v=3',
  './platho-wallet.mjs?v=8',
  './ton-mnemonic-wordlist.mjs?v=1',
  './pwa-contract-transactions.mjs?v=15',
  './vault-ton-rpc-provider.mjs?v=16',
  './ton-dns-provider.mjs?v=8',
  './capsulehub-ton-rpc-provider.mjs?v=16',
  './ath-ton-rpc-provider.mjs?v=9',
  './profile-registry-ton-rpc-provider.mjs?v=12',
  './username-ton-rpc-provider.mjs?v=14',
  './crypto/platho-crypto.mjs?v=5',
  './replay-store.mjs?v=1',
  './vault-chain-provider.mjs?v=2',
