const CACHE_NAME = 'platho-pwa-prototype-v542';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=151',
  ...
  './publish-batch-orchestration.mjs?v=3',
  './vault-ton-rpc-provider.mjs?v=49',
  './ton-dns-provider.mjs?v=29',
  './capsulehub-ton-rpc-provider.mjs?v=45',
  './ath-ton-rpc-provider.mjs?v=31',
  './profile-registry-ton-rpc-provider.mjs?v=33',
  './username-ton-rpc-provider.mjs?v=36',
  './crypto/platho-crypto.mjs?v=12',
  './replay-store.mjs?v=1',
  './vault-chain-provider.mjs?v=7',
