const CACHE_NAME = 'platho-pwa-prototype-v560';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=159',
  ...
  './vault-ton-rpc-provider.mjs?v=52',
  './ton-dns-provider.mjs?v=32',
  './capsulehub-ton-rpc-provider.mjs?v=48',
  './ath-ton-rpc-provider.mjs?v=34',
  './profile-registry-ton-rpc-provider.mjs?v=36',
  './username-ton-rpc-provider.mjs?v=39',
