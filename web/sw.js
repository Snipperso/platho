...
const CACHE_NAME = 'platho-pwa-c8133ace7351';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=371',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=bcb4faabe while the cache holds ./app.js?v=bcb4faabe. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=bcb4faabe<hash>, ./conv-lane.mjs?v=32). A changed file
