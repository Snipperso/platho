const CACHE_NAME = 'platho-pwa-prototype-v539';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=151',
  ...
  './vault-ton-rpc-provider.mjs?v=47',
  './ton-dns-provider.mjs?v=27',
  './capsulehub-ton-rpc-provider.mjs?v=43',
  './ath-ton-rpc-provider.mjs?v=29',
  './profile-registry-ton-rpc-provider.mjs?v=31',
  './username-ton-rpc-provider.mjs?v=34',
