const CACHE_NAME = 'platho-pwa-prototype-v922';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=292',
  ...
  './platho-wallet.mjs?v=30',
  './ton-mnemonic-wordlist.mjs?v=1',
  './pwa-contract-transactions.mjs?v=36',
  './publish-batch-orchestration.mjs?v=9',
  './ton-rpc-transport.mjs?v=74',
  './ton-dns-provider.mjs?v=52',
  './ath-ton-rpc-provider.mjs?v=53',
  './profile-registry-ton-rpc-provider.mjs?v=56',
  './username-ton-rpc-provider.mjs?v=58',
  './crypto/platho-crypto.mjs?v=14',
