const CACHE_NAME = 'platho-pwa-prototype-v477';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=140',
  './app.js?v=414',
  './platho-config.mjs?v=70',
  ...
  './vault-ton-rpc-provider.mjs?v=34',
  './ton-dns-provider.mjs?v=19',
  './capsulehub-ton-rpc-provider.mjs?v=34',
  './ath-ton-rpc-provider.mjs?v=21',
  './profile-registry-ton-rpc-provider.mjs?v=23',
  './username-ton-rpc-provider.mjs?v=26',
