...
const CACHE_NAME = 'platho-pwa-18f8b09bfb92';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=371',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b7b73aa2f while the cache holds ./app.js?v=b7b73aa2f. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b7b73aa2f<hash>, ./conv-lane.mjs?v=32). A changed file
