...
const CACHE_NAME = 'platho-pwa-88c83caca17b';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=340',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b3934c3f3 while the cache holds ./app.js?v=b3934c3f3. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b3934c3f3<hash>, ./conv-lane.mjs?v=30). A changed file
