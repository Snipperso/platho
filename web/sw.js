const CACHE_NAME = 'platho-pwa-prototype-v832';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=257',
  ...
  './vault-ton-rpc-provider.mjs?v=61',
  './ton-dns-provider.mjs?v=39',
  './capsulehub-ton-rpc-provider.mjs?v=58',
  './ath-ton-rpc-provider.mjs?v=41',
  './profile-registry-ton-rpc-provider.mjs?v=43',
  './username-ton-rpc-provider.mjs?v=46',
