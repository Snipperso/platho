...
const CACHE_NAME = 'platho-pwa-283d171491e4';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=343',
  ...
  './public-channel-subscriptions.mjs?v=56',
  ...
  './notes-lane.mjs?v=28',
  './public-lane-send.mjs?v=22',
  './public-lane.mjs?v=43',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b13d32f36 while the cache holds ./app.js?v=b13d32f36. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b13d32f36<hash>, ./conv-lane.mjs?v=32). A changed file
