const CACHE_NAME = 'platho-pwa-prototype-v561';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=159',
  ...
  './vault-ton-rpc-provider.mjs?v=53',
  './ton-dns-provider.mjs?v=33',
  './capsulehub-ton-rpc-provider.mjs?v=49',
  './ath-ton-rpc-provider.mjs?v=35',
  './profile-registry-ton-rpc-provider.mjs?v=37',
  './username-ton-rpc-provider.mjs?v=40',
