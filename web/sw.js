...
const CACHE_NAME = 'platho-pwa-3dba62c249ee';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=343',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b4bb243d6 while the cache holds ./app.js?v=b4bb243d6. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b4bb243d6<hash>, ./conv-lane.mjs?v=32). A changed file
