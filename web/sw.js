...
const CACHE_NAME = 'platho-pwa-8d4ae7fee937';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=340',
  ...
  './platho-wallet.mjs?v=35',
  './ton-mnemonic-wordlist.mjs?v=1',
  './pwa-contract-transactions.mjs?v=37',
  './publish-batch-orchestration.mjs?v=10',
  './ton-rpc-transport.mjs?v=77',
  './ton-dns-provider.mjs?v=55',
  './ath-ton-rpc-provider.mjs?v=56',
  './profile-registry-ton-rpc-provider.mjs?v=59',
  './username-ton-rpc-provider.mjs?v=61',
  ...
  './airdrop-ticket-read.mjs?v=18',
  './conv-discovery.mjs?v=19',
  './conv-key-persist.mjs?v=6',
  './conv-key-store.mjs?v=4',
  './conv-lane-read.mjs?v=23',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=bf4c6ada6 while the cache holds ./app.js?v=bf4c6ada6. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=bf4c6ada6<hash>, ./conv-lane.mjs?v=27). A changed file
