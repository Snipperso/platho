const CACHE_NAME = 'platho-pwa-prototype-v827';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=256',
  ...
  './vault-ton-rpc-provider.mjs?v=59',
  './ton-dns-provider.mjs?v=37',
  './capsulehub-ton-rpc-provider.mjs?v=56',
  './ath-ton-rpc-provider.mjs?v=39',
  './profile-registry-ton-rpc-provider.mjs?v=41',
  './username-ton-rpc-provider.mjs?v=44',
