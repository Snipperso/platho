...
const CACHE_NAME = 'platho-pwa-62d6283623b1';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=340',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=bbe2c38b9 while the cache holds ./app.js?v=bbe2c38b9. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=bbe2c38b9<hash>, ./conv-lane.mjs?v=25). A changed file
