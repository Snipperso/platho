const CACHE_NAME = 'platho-pwa-prototype-v830';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=257',
  ...
  './vault-ton-rpc-provider.mjs?v=60',
  './ton-dns-provider.mjs?v=38',
  './capsulehub-ton-rpc-provider.mjs?v=57',
  './ath-ton-rpc-provider.mjs?v=40',
  './profile-registry-ton-rpc-provider.mjs?v=42',
  './username-ton-rpc-provider.mjs?v=45',
