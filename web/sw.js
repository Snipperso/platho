...
const ASSETS = [
  ...
  './platho-wallet.mjs?v=27',
  './ton-mnemonic-wordlist.mjs?v=1',
  './pwa-contract-transactions.mjs?v=35',
  './publish-batch-orchestration.mjs?v=8',
  './ton-rpc-transport.mjs?v=71',
  './ton-dns-provider.mjs?v=49',
  './ath-ton-rpc-provider.mjs?v=50',
  './profile-registry-ton-rpc-provider.mjs?v=53',
  './username-ton-rpc-provider.mjs?v=55',
