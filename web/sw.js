const CACHE_NAME = 'platho-pwa-prototype-v319';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=126',
  './app.js?v=259',
  './platho-config.mjs?v=46',
  ...
  './platho-wallet.mjs?v=9',
  './ton-mnemonic-wordlist.mjs?v=1',
  './pwa-contract-transactions.mjs?v=17',
  './vault-ton-rpc-provider.mjs?v=19',
  './ton-dns-provider.mjs?v=9',
  './capsulehub-ton-rpc-provider.mjs?v=17',
  './ath-ton-rpc-provider.mjs?v=10',
  './profile-registry-ton-rpc-provider.mjs?v=13',
  './username-ton-rpc-provider.mjs?v=15',
