...
const CACHE_NAME = 'platho-pwa-0530abd253c0';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=339',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b7e0b0aac while the cache holds ./app.js?v=b7e0b0aac. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b7e0b0aac<hash>, ./conv-lane.mjs?v=21). A changed file
