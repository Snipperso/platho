...
const CACHE_NAME = 'platho-pwa-76dc0dcfdd18';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=339',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b2bb1c563 while the cache holds ./app.js?v=b2bb1c563. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b2bb1c563<hash>, ./conv-lane.mjs?v=19). A changed file
