...
const CACHE_NAME = 'platho-pwa-59673bc24826';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=338',
  ...
  './airdrop-ticket-read.mjs?v=15',
  './conv-discovery.mjs?v=15',
  './conv-key-persist.mjs?v=4',
  './conv-key-store.mjs?v=2',
  './conv-lane-read.mjs?v=17',
  './conv-lane-send.mjs?v=15',
  './conv-lane.mjs?v=18',
  './conv-publish-browser.mjs?v=4',
  './conv-reply-bundle.mjs?v=4',
  './crypto/conv-routing.mjs?v=2',
  './crypto/intro-handshake.mjs',
  './intro-bucket.mjs?v=15',
  './intro-codec.mjs?v=2',
  './intro-cursor-store.mjs?v=1',
  './intro-lane-send.mjs?v=15',
  './intro-lane.mjs?v=21',
  './intro-publish-browser.mjs?v=15',
  './intro-receive-handler.mjs?v=4',
  './intro-receive.mjs',
  './intro-scan-policy.mjs?v=1',
  './intro-scan-runner.mjs?v=15',
  './intro-scan.mjs',
  './intro-send-coords.mjs?v=15',
  './intro-transport.mjs?v=16',
  './key-shard-register-browser.mjs?v=4',
  './key-shard-register-send.mjs?v=15',
  './key-shard-ton-rpc-provider.mjs?v=4',
  './market-stability-buy-send.mjs?v=2',
  './market-stability-read.mjs?v=1',
  './notes-lane.mjs?v=15',
  './public-lane-send.mjs?v=15',
  './public-lane.mjs?v=26',
  './public-publish-browser.mjs?v=4',
  './public-shard-ton-rpc-provider.mjs?v=4',
  './publish-price.mjs?v=1',
  './recovery-blob.mjs?v=5',
  './recovery-lane.mjs?v=15',
  './recovery-publish-browser.mjs?v=15',
  './recovery-transport.mjs?v=16',
  './shard-address.mjs?v=7',
  './shard-discovery.mjs?v=17',
  './shard-reader.mjs?v=15',
  './shard-rpc.mjs?v=15',
  './ton-stack-num.mjs?v=1',
  './wallet-send-fee.mjs?v=3',
