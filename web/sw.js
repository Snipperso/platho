const CACHE_NAME = 'platho-pwa-prototype-v476';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=140',
  './app.js?v=413',
  './platho-config.mjs?v=69',
  './capsule-part-policy.mjs?v=3',
  './message-pricing-policy.mjs?v=11',
  ...
  './platho-wallet.mjs?v=12',
  './ton-mnemonic-wordlist.mjs?v=1',
  './pwa-contract-transactions.mjs?v=24',
  './vault-ton-rpc-provider.mjs?v=33',
  './ton-dns-provider.mjs?v=18',
  './capsulehub-ton-rpc-provider.mjs?v=33',
  './ath-ton-rpc-provider.mjs?v=20',
  './profile-registry-ton-rpc-provider.mjs?v=22',
  './username-ton-rpc-provider.mjs?v=25',
  './crypto/platho-crypto.mjs?v=11',
  './replay-store.mjs?v=1',
  './vault-chain-provider.mjs?v=5',
