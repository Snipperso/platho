...
const CACHE_NAME = 'platho-pwa-c4add3fecbe2';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=347',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=bf7c358f9 while the cache holds ./app.js?v=bf7c358f9. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=bf7c358f9<hash>, ./conv-lane.mjs?v=32). A changed file
