...
const CACHE_NAME = 'platho-pwa-6f6cef687534';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=339',
  ...
  './public-channel-subscriptions.mjs?v=51',
  ...
  './intro-receive-handler.mjs?v=5',
  './intro-receive.mjs',
  './intro-scan-policy.mjs?v=1',
  './intro-scan-runner.mjs?v=18',
  './intro-scan.mjs',
  './intro-send-coords.mjs?v=18',
  './intro-transport.mjs?v=19',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b5f84c635 while the cache holds ./app.js?v=b5f84c635. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b5f84c635<hash>, ./conv-lane.mjs?v=21). A changed file
