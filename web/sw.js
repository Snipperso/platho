const CACHE_NAME = 'platho-pwa-prototype-v536';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=151',
  ...
  './vault-ton-rpc-provider.mjs?v=45',
  './ton-dns-provider.mjs?v=25',
  './capsulehub-ton-rpc-provider.mjs?v=41',
  './ath-ton-rpc-provider.mjs?v=27',
  './profile-registry-ton-rpc-provider.mjs?v=29',
  './username-ton-rpc-provider.mjs?v=32',
