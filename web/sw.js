...
const ASSETS = [
  ...
  './platho-wallet.mjs?v=28',
  './ton-mnemonic-wordlist.mjs?v=1',
  './pwa-contract-transactions.mjs?v=35',
  './publish-batch-orchestration.mjs?v=8',
  './ton-rpc-transport.mjs?v=72',
  './ton-dns-provider.mjs?v=50',
  './ath-ton-rpc-provider.mjs?v=51',
  './profile-registry-ton-rpc-provider.mjs?v=54',
  './username-ton-rpc-provider.mjs?v=56',
