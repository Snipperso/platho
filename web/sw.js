...
const CACHE_NAME = 'platho-pwa-75e20269a5c7';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=352',
  ...
  './public-channel-subscriptions.mjs?v=57',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b21acaf1e while the cache holds ./app.js?v=b21acaf1e. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b21acaf1e<hash>, ./conv-lane.mjs?v=32). A changed file
