const CACHE_NAME = 'platho-pwa-prototype-v556';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=159',
  ...
  './boot-guard.js?v=3',
  './platho-config.mjs?v=89',
  './capsule-part-policy.mjs?v=3',
  './message-pricing-policy.mjs?v=13',
  './public-channel-subscriptions.mjs?v=10',
  './recipient-identities.mjs?v=6',
  './channels/platho.app/feed.json',
  './encrypted-message-store.mjs?v=5',
  './platho-wallet.mjs?v=17',
  './ton-mnemonic-wordlist.mjs?v=1',
  './pwa-contract-transactions.mjs?v=30',
  './publish-batch-orchestration.mjs?v=4',
  './vault-ton-rpc-provider.mjs?v=50',
  './ton-dns-provider.mjs?v=30',
  './capsulehub-ton-rpc-provider.mjs?v=46',
  './ath-ton-rpc-provider.mjs?v=32',
  './profile-registry-ton-rpc-provider.mjs?v=34',
  './username-ton-rpc-provider.mjs?v=37',
