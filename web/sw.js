const CACHE_NAME = 'platho-pwa-prototype-v305';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=123',
  './app.js?v=245',
  './platho-config.mjs?v=44',
  './capsule-part-policy.mjs?v=2',
  './message-pricing-policy.mjs?v=10',
  './public-channel-subscriptions.mjs?v=6',
  './recipient-identities.mjs?v=2',
  './channels/platho.app/feed.json',
  './encrypted-message-store.mjs?v=2',
  './platho-wallet.mjs?v=7',
  './ton-mnemonic-wordlist.mjs?v=1',
  './pwa-contract-transactions.mjs?v=14',
  './vault-ton-rpc-provider.mjs?v=15',
  './ton-dns-provider.mjs?v=7',
  './capsulehub-ton-rpc-provider.mjs?v=15',
  './ath-ton-rpc-provider.mjs?v=8',
  './profile-registry-ton-rpc-provider.mjs?v=11',
  './username-ton-rpc-provider.mjs?v=13',
  './crypto/platho-crypto.mjs?v=2',
  './crypto/platho-crypto.mjs?v=4',
  './replay-store.mjs?v=1',
  './vault-chain-provider.mjs?v=1',
