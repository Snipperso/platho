const CACHE_NAME = 'platho-pwa-prototype-v565';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=159',
  ...
  './vault-ton-rpc-provider.mjs?v=55',
  './ton-dns-provider.mjs?v=35',
  './capsulehub-ton-rpc-provider.mjs?v=52',
  './ath-ton-rpc-provider.mjs?v=37',
  './profile-registry-ton-rpc-provider.mjs?v=39',
  './username-ton-rpc-provider.mjs?v=42',
