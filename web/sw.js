...
const CACHE_NAME = 'platho-pwa-5de7e7a846a5';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=372',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b9d21530f while the cache holds ./app.js?v=b9d21530f. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b9d21530f<hash>, ./conv-lane.mjs?v=32). A changed file
