const CACHE_NAME = 'platho-pwa-prototype-v558';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=159',
  ...
  './vault-ton-rpc-provider.mjs?v=51',
  './ton-dns-provider.mjs?v=31',
  './capsulehub-ton-rpc-provider.mjs?v=47',
  './ath-ton-rpc-provider.mjs?v=33',
  './profile-registry-ton-rpc-provider.mjs?v=35',
  './username-ton-rpc-provider.mjs?v=38',
