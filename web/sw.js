const CACHE_NAME = 'platho-pwa-prototype-v532';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=151',
  ...
  './vault-ton-rpc-provider.mjs?v=44',
  './ton-dns-provider.mjs?v=24',
  './capsulehub-ton-rpc-provider.mjs?v=40',
  './ath-ton-rpc-provider.mjs?v=26',
  './profile-registry-ton-rpc-provider.mjs?v=28',
  './username-ton-rpc-provider.mjs?v=31',
