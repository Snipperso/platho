const CACHE_NAME = 'platho-pwa-prototype-v540';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=151',
  ...
  './vault-ton-rpc-provider.mjs?v=48',
  './ton-dns-provider.mjs?v=28',
  './capsulehub-ton-rpc-provider.mjs?v=44',
  './ath-ton-rpc-provider.mjs?v=30',
  './profile-registry-ton-rpc-provider.mjs?v=32',
  './username-ton-rpc-provider.mjs?v=35',
