...
const CACHE_NAME = 'platho-pwa-91cfe92c6790';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=339',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=bf902a13f while the cache holds ./app.js?v=bf902a13f. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=bf902a13f<hash>, ./conv-lane.mjs?v=22). A changed file
