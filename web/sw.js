const CACHE_NAME = 'platho-pwa-prototype-v917';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=290',
  ...
  './platho-wallet.mjs?v=29',
  './ton-mnemonic-wordlist.mjs?v=1',
  './pwa-contract-transactions.mjs?v=35',
  './publish-batch-orchestration.mjs?v=8',
  './ton-rpc-transport.mjs?v=73',
  './ton-dns-provider.mjs?v=51',
  './ath-ton-rpc-provider.mjs?v=52',
  './profile-registry-ton-rpc-provider.mjs?v=55',
  './username-ton-rpc-provider.mjs?v=57',
