...
const CACHE_NAME = 'platho-pwa-98c8f4f46413';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=340',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b4883a617 while the cache holds ./app.js?v=b4883a617. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b4883a617<hash>, ./conv-lane.mjs?v=30). A changed file
