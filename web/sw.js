...
const CACHE_NAME = 'platho-pwa-d201f5e19f92';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=340',
...
async function navigationResponse(event) {
  ...
  try {
    ...
    // ./app.js?v=b8868a165 while the cache holds ./app.js?v=b8868a165. Online nobody notices, the network fills the gap.
 ...
 *
 * Every module URL here carries its content's version (./app.js?v=b8868a165<hash>, ./conv-lane.mjs?v=30). A changed file
