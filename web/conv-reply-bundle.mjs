...
import { publicKeyBundleFromVaultKeyRecord, CRYPTO_SUITES } from './crypto/platho-crypto.mjs?v=21';
import { readSnakeCellBytes } from './pwa-contract-transactions.mjs?v=47';
