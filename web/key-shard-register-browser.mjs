...
import { beginCell, snakeCellFromBytes } from './pwa-contract-transactions.mjs?v=37';
import { keyShardAddressBytes, keyShardStateInit, rawAddress } from './shard-address.mjs?v=7';
