...
import { selfRecoveryShardSpace, selfRecoveryShard } from './conv-discovery.mjs?v=7';
import { sealRecoveryBlob, openRecoveryBlob, sealPrefsBlob, openPrefsBlob } from './recovery-blob.mjs?v=2';
import { buildRecoveryPublishBrowser } from './recovery-publish-browser.mjs?v=7';
import { RECOVERY_MAX_SLOTS, PREFS_NAMED_SLOT_INDEX, addrKey } from './shard-discovery.mjs?v=9';
import { probeActiveAddresses } from './shard-reader.mjs?v=7';
