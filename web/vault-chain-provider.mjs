import { parseTonAddress, verifyVaultKeyRecordBinding } from './crypto/platho-crypto.mjs';
...
function normalizeVaultKeyRecordView(record) {
  ...
  return {
    ...record,
    exists: true,
    owner_wallet: normalizeAddressLike(field(record, 'owner_wallet', 'ownerWallet'), 'Vault key record owner_wallet'),
