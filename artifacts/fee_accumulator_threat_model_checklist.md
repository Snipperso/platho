...
- Split accounting: exact 50/50 integer split with dust to buyback.
...
- Testnet/mainnet gas envelope measurement for deposit, split, treasury flush, and buyback bounce.
