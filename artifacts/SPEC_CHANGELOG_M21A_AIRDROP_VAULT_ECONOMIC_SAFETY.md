...
- Added tests asserting the 15% airdrop constants and the funding blocker are present in the implemented-subset manifest.
...
- 15% activity airdrop amount unchanged.
